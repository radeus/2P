<!-- This is the Czech Greenways Trail page template -->

<!-- additional shit has been added -->

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xml:lang="<?php print $language->language; ?>" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>">
...
<head>
  ...
  <meta name="geo.position" content="49.140748; 15.3715775" />
  <meta name="ICBM" content="49.140748, 15.3715775" />
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

</head>
<body class="<?php print $body_classes; ?> arg-0-<?php print arg(0); ?> sidebar-left" onunload="GUnload();" style="margin:0px;">
...
<?php endif; ?>
    ...
    <?php if ($logo or $site_name): ?>
      <div id="logo-title">
        ...
        <?php if ($logo && $Xis_front): ?>
          <div id="logo"><a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print base_path().path_to_theme().'/logo-front.png'; ?>" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
        <?php elseif ($logo): ?>
